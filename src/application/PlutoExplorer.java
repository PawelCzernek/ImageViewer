...
//        link.setTooltip(new Tooltip(IMAGE_CREDIT_URL));
        HBox menu = createMenu(imageView, primaryStage);

        HBox buttons = createButtons(imageView);
        ...
        VBox root = new VBox(menu, container, buttons);
    ...
    private HBox createMenu(ImageView imageView, Stage primaryStage) {
        Button newImage = new Button("Import image");
        ...
        HBox menuBox = new HBox(10, newImage);
    ...
    private HBox createButtons(ImageView imageView) {
        Button reset = new Button("Reset");
        reset.setOnAction(e -> reset(imageView));
        Button full = new Button("Full view");
        full.setOnAction(e -> reset(imageView));
